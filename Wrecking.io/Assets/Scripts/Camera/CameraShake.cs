...
public class CameraShake : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        maximumTranslationShake.z * (Mathf.PerlinNoise(seed + 2, Time.time * frequency) * 2 - 1)) * shake;
        ...
        maximumAngularShake.z * (Mathf.PerlinNoise(seed + 5, Time.time * frequency) * 2 - 1)) * shake);
